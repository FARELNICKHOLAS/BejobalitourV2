<header class="mb-2 px-4 fixed top-0 left-0 right-0 bg-white z-10 shadow-md" id="navbar">
    <div class="relative mx-auto flex max-w-screen-lg flex-col py-6 sm:flex-row sm:items-center sm:justify-between">
      <a class="flex items-center text-2xl font-bold text-green-500" href="/">
      ...
      <nav aria-label="Header Navigation" class="peer-checked:block hidden pl-2 py-6 sm:block sm:py-0">
        <ul class="flex flex-col gap-y-4 sm:flex-row sm:gap-x-8">
          <li><a class="text-lg text-gray-600 hover:text-green-600" href="/">Home</a></li>
          <li><a class="text-lg text-gray-600 hover:text-green-600" href="/destination"> <Data>Tour Packages</Data></a></li>
          <li><a class="text-lg text-gray-600 hover:text-green-600" href="/gallery">Gallery</a></li>
          <li><a class="text-lg text-gray-600 hover:text-green-600" href="/about">About</a></li>
          <li class="mt-2 sm:mt-0">
            <a class="rounded-xl border-2 border-green-600 px-6 py-2 font-medium text-green-600 bg-white hover:bg-green-600 hover:text-white transform hover:scale-105 transition duration-300 ease-in-out" href="https://wa.link/nyw55n">Contact Us</a>
          </li>
        </ul>
      </nav>
    </div>
